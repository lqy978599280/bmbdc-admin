<template>
  <el-dialog :title="title" :visible.sync="dialogFormVisible" width="800px" :before-close='dialogfv'>
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="status5" v-show="getdata.status ==='待房产经纪人完成'">{{buttonCommit}}</el-button>
      <el-button type="primary" @click="status6" v-show="getdata.status ==='待买方确认'">{{buttonCommit}}</el-button>
    </div>
  </el-dialog>
    ...
    export default {
        ...
        methods: {
            ...
            statusChangeCommit() {
                ...
                axios.post(`${this.global.config.url}/admin/dkfOrders/updateStatus`, {
                        id: this.pass_id,
