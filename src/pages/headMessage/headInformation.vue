<template>
  <div>
    <div class="main-top">
      ...
      <headInformationEdit :data="form"
                     :dialogFormVisible="dialogadd"
                     @dialogcommit="dialogcommit"
                     @getdialogfv="getdialogfv"
                     :title="title[0]"
                     :buttonClose="buttonClose"
                     :buttonCommit="buttonCommit"></headInformationEdit>
      <headInformationEdit :data="filterFlyData[index]"
...
<script>
import headInformationEdit from "./headInformationEdit";
    ...
    export default {
        ...
        methods: {
            ...
            dialogcommit(val, data) {
                ...
                // console.log(data);
                axios.post(`${this.global.config.url}/admin/article/insertArticle`, data)
                    .then((response) => {
            ...
            dialogeditcommit(val, data) {
                ...
                axios.post(`${this.global.config.url}/admin/article/updateArticle`, data)
                    .then((response) => {
                        this.message(response)
                        this.handleCurrentChange()
                    })
            ...
            commitdel(val, id) {
                ...
                // console.log(id);
                axios.get(`${this.global.config.url}/admin/article/deleteArticle`, {params: {id: id}})
                    .then((response) => {
                        this.message(response)
                        this.handleCurrentChange()
                    })
            ...
            handleCurrentChange() {
                const axios = require("axios")
                axios.get(`${this.global.config.url}/admin/article/selectAllArticle?page=${this.currentPage}&size=8`)
                    .then((response) => {
                        // console.log(response);
